...
<div class="container my-24 mx-auto md:px-6">
  ...
  <section class="mb-32">
    <div
      class="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat bg-[url('https://previews.123rf.com/images/dbvirago/dbvirago1110/dbvirago111000084/10888930-un-nuevo-s%C3%A1ndwich-de-fiambre-y-queso-en-pan-reci%C3%A9n-horneado.jpg')]">
    </div>
      ...
      <div
        ...
        <div class="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
          <div class="mx-auto mb-12 text-center lg:mb-0">
            ...
            <h6 class="font-medium">Argentina</h6>
          </div>
          <div class="mx-auto mb-12 text-center lg:mb-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
              stroke="currentColor" class="mx-auto mb-6 h-8 w-8 text-primary dark:text-primary-400">
            ...
            <h6 class="font-medium">Somewhere in Argentina</h6>
          </div>
          <div class="mx-auto mb-6 text-center md:mb-0">
            ...
            <h6 class="font-medium">+ 54 1111111111</h6>
          </div>
          <div class="mx-auto text-center">
            ...
            <h6 class="font-medium">Debit/Credit/QR</h6>
          </div>
        </div>
